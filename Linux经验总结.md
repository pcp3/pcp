...
* [1 硬盘分区及格式化](#1-硬盘分区及格式化)
  * [1.1 硬盘分区](#11-硬盘分区)
  * [1.2 分区格式化](#12-分区格式化)
  * [1.3 挂载到目录](#13-挂载到目录)
* [2 systemctl命令介绍](#2-systemctl命令介绍)
  * [2.1 启停命令](#21-启停命令)
  * [2.2 开机设置](#22-开机设置)
  * [3.3 查看命令](#33-查看命令)
* [3 yum缓存离线rpm包](#3-yum缓存离线rpm包)
  * [3.1 连通互联网](#31-连通互联网)
  * [3.2 配置163的源](#32-配置163的源)
  * [3.3 设置Yum缓存](#33-设置yum缓存)
* [4 免密钥登录](#4-免密钥登录)
* [5 后台进程监控工具](#5-后台进程监控工具)
  * [5.1 安装工具](#51-安装工具)
  * [5.2 常用命令](#52-常用命令)
* [6 根据内容查找文件](#6-根据内容查找文件)
* [7 安装Python3环境（与python2并存）](#7-安装python3环境（与python2并存）)
  * [7.1 安装Python3](#71-安装python3)
